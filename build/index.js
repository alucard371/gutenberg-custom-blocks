...
class TeamMemberEdit extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    _defineProperty(this, "updateAlt", alt => {
      this.props.setAttributes({
        alt
      });
    });
    ...
    _defineProperty(this, "onSortEnd", (oldIndex, newIndex) => {
      const {
        setAttributes,
        attributes
      } = this.props;
      ...
      let new_social = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_6__["arrayMove"])(social, oldIndex, newIndex);
      setAttributes({
        social: new_social
      });
      this.setState({
  ...
  render() {
    ...
    const SortableLink = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_6__["SortableContainer"])(() => {
      return /*#__PURE__*/React.createElement("ul", null, social.map((item, index) => {
        let SortableItem = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_6__["SortableElement"])(() => {
    ...
    }, url && !Object(_wordpress_blob__WEBPACK_IMPORTED_MODULE_2__["isBlobURL"])(url) && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["TextareaControl"], {
  ...
  transforms: {
    from: [{
      ...
      transform: ({
        ...
        let inner = images.map(({
          alt,
          id,
          url
        }) => Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('qtd-blocks/team-member', {
          alt,
          id,
          url
        }));
        return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('qtd-blocks/team-members', {
          columns: columns
        }, inner);
      }
    }]
